...
const Nav = ()=>{
  ...
  return (
    ...
    <b className="navbar-brand text-success " href="#">MyWorking List</b>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <button className="btn btn-outline-success my-sm-0" type="submit">SignUp</button>
      <button className="btn btn-success my-sm-0 mx-2" type="submit">SignIn</button>
          <img 
          className="img_fluid user-png"
